...
\node[umlclass] (Researcher) at (0,8) {Researcher};
\node[umlclass] (Supervisor) at (0,4) {Project Supervisor};
\node[umlclass] (Developer) at (0,0) {Developer};

\node[umlclass] (FRDR) at (6,0) {FRDR Repository};
\node[umlclass] (Trial) at (6,4) {Trial};
\node[umlclass] (Rat) at (6,8) {Rat};

\node[umlclass] (Condition) at (12,8) {Condition};
\node[umlclass] (Behavior) at (12, 4) {Behavior};
\node[umlclass] (Metadata) at (12,0) {Metadata};
