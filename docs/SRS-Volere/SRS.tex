...
\begin{itemize}
    ...
    \item \textbf{SUP.R.2:} The system shall be self-supporting outside of the user manual as the developers will not be able
...
\begin{itemize}
    ...
    \item \textbf{ADA.R.2:} The system is expected to run on the top three most popular web browsers.
    \item \textbf{ADA.R.3:} The system is expected to maintain reasonable performance for users using devices
