...
\begin{itemize}
    \item \textbf{Database and Backend}: PostgreSQL schema, FastAPI endpoints, metadata management, spatial-temporal indexing, video file management.
...
\hline
UC2: Download Data & Researcher & Download trials or videos & Dataset query completed & Files downloaded \\
\hline
UC3: Visualize Trajectories & Researcher & Plot movement paths & Data subset selected & Interactive plots displayed \\
\hline
UC4: Video with Trajectory & Researcher & Play video with trajectory overlay & Video and trajectory linked & Video + overlay displayed \\
\hline
UC5: Natural Language Query & Researcher & Enter plain-English query & NLP service available & Relevant trials returned \\
\hline
UC6: Automated Analysis & Researcher & Run predefined workflows & Data subset selected & Metrics/graphs generated \\
\hline
UC7: Manage Metadata & Admin/Developer & Update metadata schema & Admin privileges & Metadata updated \\
\hline
UC8: Deployment \& Access & DevOps Engineer & Deploy platform online & Backend/frontend configured & Platform accessible \\
\hline
\end{tabular}
...
\textbf{PUC1: Search and Filter Data}\\
The researcher searches the dataset using filters such as trial number, injection count, or behavioral pattern. The system returns relevant subsets of data.  

\textbf{PUC2: Download Data}\\
The researcher downloads selected subsets of trials, metadata, or video files for offline analysis.  

\textbf{PUC3: Run Automated Analysis}\\
The researcher executes predefined workflows (e.g., measuring exploration or compulsive checking behavior). The system outputs metrics, graphs, and summary reports.  
