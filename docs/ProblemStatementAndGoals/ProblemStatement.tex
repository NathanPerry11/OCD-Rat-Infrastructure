...
\paragraph{The first extra deliverable will be a performance report on areas of the software application where performance should be optimized. The second extra deliverable will be a user manual on the intended use of the software application.}
