...
\item[\refstepcounter{acnum} \actheacnum \label{acDataVisualization}:] The frameworks used for 
  creating visualizations from data and presenting them.
\item[\refstepcounter{acnum} \actheacnum \label{acAccessControl}:] The implementation of the access control 
mechanism for user scalability.
\end{description}
